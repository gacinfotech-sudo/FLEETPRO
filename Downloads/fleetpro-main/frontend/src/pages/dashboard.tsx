        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => setShowBookingForm(true)}>
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => setCurrentView("fleet")}>
                <CardContent className="p-4 lg:p-6 text-center">
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => setCurrentView("revenue")}>
                <CardContent className="p-4 lg:p-6 text-center">
